...
class WindowTrackerService(win32serviceutil.ServiceFramework):
   
   _svc_name_ = "WindowTrackerService"
   _svc_display_name_ = "Window tracking service for Windows"
   _svc_description_ = "Tracks your windows and stores them in a sqlite3 db. You can then bla bla bla..."
